...
- Utilizar Mailtrap para utilizar em ambiente de desenvolvimento;
...
- O usuário precisa confirmar a nova semha ao resetar sua senha;
...
- Os agendamentos devem estar disponíveis entre 8h às 18h (Primeiro às 8h,
último às 17h);
